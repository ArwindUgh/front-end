...
export default function CallToAction() {
  return (
    <div className="flex flex-col sm:flex-row p-3 border border-fuchsia-600 justify-center items-center rounded-tl-3xl rounded-br-3xl text-center bg-gradient-to-r from-indigo-900 via-fuchsia-700 to-pink-500 text-white">
      <div className="flex-1 justify-center flex flex-col items-center sm:items-start">
        <h2 className="text-2xl font-bold mb-2">
          Want to explore more of <span className="bg-gradient-to-r from-yellow-400 via-amber-500 to-orange-500 bg-clip-text text-transparent">TELLYBEATSS</span>?
        </h2>
